...
RateLimitError                      OpenAI quota           Dùng gpt-4o-mini, set
                                                           max_concurrent=2
...
□ Lưu kết quả vào pairwise_results.csv với columns: question, winner_after_swap,
...
< 0.2                        Judge sai prompt, hoặc bạn label   Re-check prompt + re-label
                             inconsistent
...
A: Có thể bạn label winner theo column position thay vì content. Re-check: human label có thực sự dựa
